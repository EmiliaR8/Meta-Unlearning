...
class AGemExperiment(ContinualExperiment):
    ...
    def extra_state(self) -> dict:
        # The RNG matters as much as the memory here: `_rng` draws the reference
        # batch every step, and a resumed run that restarted it would replay the
        # same projection directions the earlier tasks already used.
